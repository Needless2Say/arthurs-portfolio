...
| **`PL-###`** | A finding id from the 2026 production launch security audit that covered this repo along with the rest of the ecosystem. Where a doc cites one, a control here exists because of that finding. The register itself is private, ask the owner for the detail behind a specific id. |
