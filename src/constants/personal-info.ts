...
export const PERSONAL_INFO = {
  name: "Arthur Krieger",
  title: "Software Engineer · CS + Data Science",
  ...
  bio: "I graduated from the University of Michigan College of Engineering in 2025 with a Bachelor of Science in Computer Science and a minor in Data Science. I currently work as a Software Engineer at Charles Schwab on the Wealth Asset Management Engineering Team, building data pipelines that ingest and transform data for analysts and scientists. Outside of work I'm always building something — from full-stack web apps to exploring ML and AI.",
  objective:
...
export const EXPERIENCE: Experience[] = [
  ...
  },
  {
    ...
    bullets: [
      "Part of a scrum team using Agile methodology; built dashboards for data operations",
      "Delivered Streamlit dashboards displaying pipeline operations and data profiling metrics in Snowflake",
  ...
  },
  {
    ...
    tech: ["Python", "SQL", "Databricks", "Azure", "Snowflake"],
  },
  {
    role: "Research Assistant",
    company: "Dept. of Ob/Gyn — Wayne State University",
    location: "Detroit, MI",
